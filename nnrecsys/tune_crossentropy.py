...
EXPERIMENT = 'tune_crossentropy_' + DATASET_NAME
...
class NNRecSys(ray.tune.Trainable):
    def _setup(self, config):
        sub_config = {
            ...
            'images': config['image_embeddings']
        }
...
def main():
    ...
    space = {
        ...
        'image_embeddings': hp.choice('images', [True, False]),
    ...
    scheduler = AsyncHyperBandScheduler(reward_attr="hitrate_at_50", grace_period=1, max_t=10)
